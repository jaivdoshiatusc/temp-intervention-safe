...
class AsteroidsEvalCallback(BaseCallback):
    ...
    def __init__(self, cfg, eval_env, eval_freq, eval_seed, gif_freq, n_eval_episodes, new_action, verbose=1):
        super(AsteroidsEvalCallback, self).__init__(verbose)
    ...
    def create_frame(self):
        ...
        blocker_line = AsteroidsEvalCallback.PLAY_AREA[1] - self.catastrophe_clearance - self.blocker_clearance
        catastrophe_line = AsteroidsEvalCallback.PLAY_AREA[1] - self.catastrophe_clearance
