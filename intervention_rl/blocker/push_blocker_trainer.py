...
class BlockerModel(nn.Module):
    def __init__(self, obs_size=76, action_dim=2, hidden1=64, hidden2=32, output_classes=3):
...
class PushBlockerTrainer:
    def __init__(self, device='cpu', obs_size=76, action_dim=2, num_classes=3, lr=1e-3):
        self.device = device
